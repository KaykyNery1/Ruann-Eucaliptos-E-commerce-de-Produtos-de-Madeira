          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-emerald-600 hover:text-emerald-500 transition-colors">Esqueceu a senha?</a>
              </div>
            </div>
            ...
            <div>
              ...
              >
                {isLoading ? <div className="flex items-center"><div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div>Entrando...</div> : "Entrar"}
              </button>
            </div>
          </form>

      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <div className="flex items-center space-x-2">
            ...
            />
            <span className="text-lg sm:text-2xl font-bold text-gray-900">RUANN EUCALIPTOS</span>
          </div>
        </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-3 py-3 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 text-base ${
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`block w-full pl-10 pr-10 py-3 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 text-base ${
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a
                 ...
                 className="font-medium text-emerald-600 hover:text-emerald-500 transition-colors cursor-pointer touch-manipulation"
                >
                  Esqueceu a senha?
                </a>
              </div>
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white transition-colors touch-manipulation ${
                  isLoading
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3">
              <button
                ...
                disabled={isLoading}
                className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-base font-medium text-gray-500 hover:bg-gray-50 transition-colors touch-manipulation"
              >
            ...
            <form onSubmit={handleForgotPassword}>
              ...
              <div className="flex space-x-2">
                ...
                <button
                  type="pointer"
                  disabled={isLoading}
                  className={`flex-1 py-3 px-4 rounded-md font-medium transition-colors touch-manipulation ${
                    isLoading

              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-150 border rounded-md focus:outline-none focus:ring-1 focus:ring-emerald-500 ${addressErrors.number ? 'border-red-300' : 'border-gray-300'}`}
                    placeholder="123"
                  />
